...
<html>
    ...
    <main>
        <h1>Background</h1>
        <p>I gained interested in engineering when I did VEX Robotics in middle school. At the time, I was only interested in the mechanical design and operation of the crude robot we were building. A funny quirk about about robot was our pseudo-linear-slide lift kept slipping off the tracks, so we added a bunch of rubber bands to hold the slide towers together more tigntly so the lift wouldn't slip.</p>
        ...
        <h1>Career Choice</h1>
        <p>By my junior year of high school, I realized I enjoyed programming enough to pursue it as a career. After searching at programs around the midwest area and looking at costs, I settled on UNL.</p>
        ...
        <p>I have fulfilled or am actively fulfilling the UNL 2019-2020 catalogue year requirements for a Bachelors of Science in Software Engineering.</p>
